...
while getopts "lsh" flag; do
    case "${flag}" in
        l ) echo "Keeping .lst files."; LIST="1";;
...
build_test()
{
    ...
    if [ "$SIGNATURE" = "1" ] ; then
        ...
        spike -m0x600000:16777216,0x80000000:8388608 --isa=RV32IMAC_Zifencei_Zicsr --misaligned --priv=m +signature=../reference/$1.sig +signature-granularity=4 TestCompliance.elf
...
# --- spike generates an exception ---
#core   0: 0x00600160 (0x14001073) csrw    sscratch, zero
#core   0: exception trap_illegal_instruction, epc 0x00600160
#build_test "csr-01";
